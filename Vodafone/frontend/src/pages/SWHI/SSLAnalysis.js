  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
          ...
          {daysUntilExpiry !== null && (
            <div className="mt-3">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className={`font-semibold ${daysUntilExpiry < 30 ? 'text-red-400' :
        ...
        {/* Certificate Details */}
        {!sslInfo.subject && (
          <div className="cyber-border p-8 rounded-lg text-center bg-red-900/5">
            <XCircle className="h-10 w-10 text-red-500/50 mx-auto mb-3" />
            <h4 className="text-gray-300 font-bold">No SSL Certificate Found</h4>
            <p className="text-sm text-gray-500 max-w-md mx-auto">
              Could not establish a secure connection to {analysis.domain}. This domain likely has no hosting infrastructure or is currently unreachable.
            </p>
          </div>
        )}
        {sslInfo.subject && (
